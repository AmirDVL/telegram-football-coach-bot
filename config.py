...
1️⃣ دوره تمرین حضوری    2️⃣ دوره تمرین آنلاین 3️⃣ برنامه غذایی"""
...
واریزی رو انجام دادی فیش رو  همینجا ارسال میکنی میریم توی کارش🤝😊💎"""
        ...
        'nutrition_plan': {
            'title': 'برنامه غذایی شخصی‌سازی شده',
            'description': """🥗 برنامه غذایی شخصی‌سازی شده
